    ...
    <div className="mx-auto w-full max-w-screen-xl py-8 p-16 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
                  <img src="/md/white_md.jpeg" className="h-8 me-3" alt="Logo" />
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                        <a href="https://www.linkedin.com/in/miya-dong/" className="hover:underline">Linkedin</a>
                      </li>
                      <li>  
                         <a href="https://github.com/realmiya" className="hover:underline ">Github</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="https://www.linkedin.com/in/miya-dong/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a href="https://github.com/realmiya" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  <FaGithubAlt />
